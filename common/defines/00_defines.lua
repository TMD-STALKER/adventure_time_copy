...
NGame = {
	...
	MISSION_REMOVE_FROM_INTERFACE_DEFAULT = 5,		-- Default days before a mission is removed from the interface after having failed or completed
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "3008.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NAI = {
	...
	WANTED_UNITS_THREAT_BASE = 2,                             -- If no threat, multiply min wanted units by this
	WANTED_UNITS_THREAT_MAX = 6.0,                             -- Normalized threat is clamped to this
	WANTED_UNITS_WAR_THREAT_FACTOR = 2.15,                       -- Factor threat with this if country is at war. this value is overriden by the value in ideology database if that value exceedes this.
	WANTED_UNITS_DANGEROUS_NEIGHBOR_FACTOR = 2.15,              -- Factor if has dangerous neighbor
	...
	WANTED_UNITS_WEIGHT_FRONTS_WANT = 1,                      -- Weight of front needs when computing final nr wanted units
	...
	WANTED_UNITS_MAX_WANTED_CAP = 100,	-- Maximum wanted divisions for a country. This can be exceeded by certain hardcoded multipliers, but not by base calculation logic.
