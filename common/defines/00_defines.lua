...
NAI = {
	...
	WANTED_UNITS_THREAT_BASE = 0.6,                             -- If no threat, multiply min wanted units by this
	...
	WANTED_UNITS_WEIGHT_FRONTS_WANT = 0.5,                      -- Weight of front needs when computing final nr wanted units
